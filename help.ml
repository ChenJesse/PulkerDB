...
let cidx_msg = "Given a field that exists in the specified collection, will create an ascending index
on that field. See -index_doc for proper field formatting."

let gidx_msg = "Given an index that exists in our collection, and a key that exists for the specified index,
